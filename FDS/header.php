		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-offset-6  col-md-1 color">
					<a class="admin-heading"><!-- <i class="fa fa-user"> -->Hello <?php echo $_SESSION['username']; ?></i></a>
				</div>
				<div class="col-md-1 color">
					<a href="update-password.php?id=<?php echo $_SESSION['username']; ?>" class="admin-pass"><!-- <i class="fa fa-key"> --></i>Change pass...</a>
				</div>
				<div class="col-md-1 color">
